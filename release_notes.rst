...
* Added a more descriptive message for when Akamai Edge throws an "Invalid Timestamp" error when adding related records
...
* Fixed an issue during the creation of a secondary zone on a BIND server in the Web Application that prevented creation of the zone file (`KI-026175 <https://care.bluecatnetworks.com/s/detail/a8BPJ00000029SD2AY>`)
...
* The Men&Mice Management Console has been deprecated in version 25.1.0. This is the final version in which the Management Console is guaranteed to function with Micetro. This version will be supported for two years and, during this time, we will integrate the final features into the current version of Micetro. If you have any questions about features from the Management Console that are critical to your operation which you don't currently see replicated in Micetro, please contact BlueCat Support at support@bluecatnetworks.com.
