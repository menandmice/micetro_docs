.. meta::
   :description: Automation with REST and SOAP APIs, and platforms like Ansible and Terraform 
...
You can also use Ansible for automation. With Ansible modules and plugins, you can connect to the Micetro API to create DNS, DHCP, and IPAM workflows.
