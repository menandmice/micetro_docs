...
* DHCP exclusions on MS DHCP servers are converted to static address spaces on Kea destination servers by splitting up the pool in which the exclusions were. As a result, a warning will be generated in the migration.
