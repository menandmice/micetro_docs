...
.. note::
  ...
  * When there are no HA members defined or if Micetro Central has not been configured for HA, a message will appear, indicating further configuration is necessary. This documentation provides instructions on how to configure HA in Micetro for versions 10.2 and above. If you need to use the management console (thick client), please follow the documentation for version 10.1 (https://menandmice.com/docs/10.1/guides/implementation/central_ha).
...
7. Restart the Micetro Central from the command line:
...
8. Log in to the Web Application and verify that the current server is running with state "Active".
...
12. Start Central on the secondary server:
  ...
  * Open the Services window by pressing **Win + R**, typing **services.msc**, and hitting Enter.
  * Locate Micetro Central, right-click on it, and select **Start** and ensure it's running.
