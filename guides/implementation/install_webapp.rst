...
.. code-block:: bash
  ...
  tar -xzvf mmsuite-web-application-9.3.8.linux.x64.tgz
  cd mmsuite-web-application-9.3.8.linux.x64 && ./install --web-virtual-host-domain web-application.domain.tld
