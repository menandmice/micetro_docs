...
2. To add a new user, select :guilabel:`Create` in the task bar.

3. In the dialog box, complete the form, selecting :guilabel:`RADIUS` from the **Authentication type** dropdown. For more information about how to create users, refer to :ref:`acl-users`.

To modify an existing user, double-click the user's name in the grid to display the **Edit Properties** dialog box and select :guilabel:`RADIUS`` from the **Authentication type** dropdown list.
