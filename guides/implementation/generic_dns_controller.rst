.. meta::
   ...
   :keywords: DNS, DNS agent, generic, Micetro
...
1. Install:
   ...
   * **Linux**: Run the agent installer with the parameter ``--generic-dns-controller``.
...
5. Log into Micetro and add a new generic DNS server. The name and optional IP address must point to the machine running the generic DNS agent.
