...
.. [1] Refer to :ref:`agent-free-dns-dhcp`.
...
Services are managed on :guilabel:`Service Management` tab of the **Admin** page. To add a new service, select :guilabel:`Add Service` in the task bar. For more information and instructions, refer to :ref:`adding-service` in the Admin Guide.
