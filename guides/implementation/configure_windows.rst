.. meta::
    :description: Configuring Micetro on Windows
    :keywords: Micetro, configuration, Windows
 
.. _configure-micetro-windows:
 
Configuring Micetro on Windows
===============================
The following pages provide instructions on configuring Micetro on Windows. For example, you can configure the Micetro components to run as services.
