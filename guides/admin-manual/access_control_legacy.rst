...
.. csv-table::
  ...
  "Access to Web Interface", "Access to the Micetro Web Interface"
  "Access to basic zone view in Web Interface", "Access to the basic zone view in the Micetro Web Interface"
  "Access to advanced zone view in Web Interface", "Access to the advanced zone view in the Micetro Web Interface"
  "Access to IPAM view in Web Interface", "Access to the IPAM view in the Micetro Web Interface"
  "Access to report view in Web interface", "Access to the report view in the Micetro Web Interface"
  "Access to task list view in Web interface", "Access to the task list view in the Micetro Web Interface"
  ...
  "Access to Host editor", "Access to the host editor view in the Micetro Web interface"
  "Access to manage AD Sites and Site Links", "Access to work with AD Sites and Site Links."
  "Access to manage clouds", "Access to add/remove cloud providers into Micetro"
  ...
  "Access to 'Import Data' web task", "Access the Import Data task in Web Interface as well as to Import data into the newer Micetro Web Interface"
